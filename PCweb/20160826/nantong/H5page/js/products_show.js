		...
		$(evElWrap).on($ev,evEl,function(e){
			...
			if(extre){
				...
				if(evElWrap==".p-nav"){
					...
					$tar.addClass('choose');
					if($id=="2"){
						$('#content').addClass('bgReset');
						$('.bottom').addClass('btReset');
					} else {
						$('#content').removeClass('bgReset');
						$('.bottom').removeClass('btReset');
					}
				}
...
var pg = new ctxAct();
pg.change(".p-nav",[".content-box",".content-box"],"li",[".content",".bottom"],"","",true);
